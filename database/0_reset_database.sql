...
DROP FUNCTION IF EXISTS validate_nodes_parent_map() CASCADE;
DROP FUNCTION IF EXISTS validate_node_links_map() CASCADE;
DROP FUNCTION IF EXISTS touch_map_from_graph_changes() CASCADE;
