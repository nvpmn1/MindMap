-- ============================================
-- SCRIPT COMPLETO DE LIMPEZA + SETUP
...
-- Drop das triggers (somente se a tabela existir)
DO $$
BEGIN
    ...
    IF to_regclass('public.maps') IS NOT NULL THEN
...
-- Drop de todas as tabelas (com CASCADE para limpar constraints)
...
-- ============================================
-- PARTE 3: TRIGGERS E FUNCTIONS (após criar tabelas)
-- ============================================
...
-- Desabilitar RLS para que o backend service role acesse tudo
...
-- Garantir privilégios para service_role
DO $$
BEGIN
...
SELECT 'Setup completado com sucesso!' AS status,
       '✅ Banco limpo' AS step1,
       '✅ Schema criado' AS step2,
       '✅ Workspace padrão inserido' AS step3,
       '✅ RLS desabilitado' AS step4;
