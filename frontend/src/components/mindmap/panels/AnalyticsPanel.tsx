      ...
      <div className="w-full h-full overflow-y-auto px-5 py-4 space-y-5 scrollbar-thin scrollbar-thumb-white/5 scrollbar-track-transparent bg-[#080d16]">
        <div className="grid grid-cols-2 gap-3">
          ...
          <KPICard
            icon={Zap}
            label="Nós IA"
            value={analytics.aiGeneratedNodes}
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-white/5">
          <div className="flex items-center gap-3">
            <div
              className="w-8 h-8 rounded-xl bg-gradient-to-br from-pink-500/20 to-purple-500/20 
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-[9px] text-slate-600 mt-1">
                  {analytics.connectionDensity < 0.3
                    ? 'Baixa - considere mais conexões'
                    : analytics.connectionDensity < 0.6
                      ? 'Moderada - boa estrutura'
