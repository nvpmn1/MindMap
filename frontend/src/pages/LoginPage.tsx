...
export function LoginPage() {
  ...
  const handleSelectProfile = (profileId: string) => {
    ...
    const selected = profilesWithAvatars.find((profile) => profile.id === profileId);
          ...
          <div className="relative bg-[#080C14]/70 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 shadow-2xl space-y-5">
            ...
            >
              ...
              <motion.p
                ...
                className="text-xs text-cyan-400/60 tracking-widest uppercase"
              >
              ...
              <div className="grid grid-cols-3 gap-2">
                {profilesWithAvatars.map((profile) => {
                  ...
                  return (
                    ...
                    >
                      {/* Small avatar */}
                      <motion.div className="w-10 h-10 rounded-md overflow-hidden flex-shrink-0 border border-white/20 bg-slate-700">
                        <img
